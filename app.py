...
def load_models():
    models = {'LogisticRegression':pickle.load(open('lr1_ms_cfs.pkl','rb')),
              'DecisionTree':pickle.load(open('dt1_ms_cfs.pkl','rb')),
              'RandomForest':pickle.load(open('rf_ms_cfs1.pkl','rb'))          
                }
    return models
...
def main():
    ...
    # # Display model info
    # st.sidebar.subheader(f'{model_name} Parameters')
